...
struct CustomTabbar: View {
    ...
    var body: some View {
        HStack{
            ...
            Spacer()
            CustomTabbarBtn(name: "Profite",img: "building.fill", selectedTab: $selectedTab,current: 1)
            Spacer()
            CustomTabbarBtn(name: "Charts",img: "chart.bar.fill", selectedTab: $selectedTab,current: 2)
            Spacer()
